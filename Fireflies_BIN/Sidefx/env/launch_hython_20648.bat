...
set "HOUDINI_ROOT=C:\Fireflies\Common\Houdini_vars\houdini_205684\houdini20.5.684"
...
"C:\Fireflies\Common\Houdini_vars\houdini_205684\Houdini20.5.684\bin\hython.exe" -q %*